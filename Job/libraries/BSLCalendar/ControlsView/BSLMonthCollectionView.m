...
@property(nonatomic,strong) CalendaDaysCell * cadaycell;
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (dayModel.month == 9 && dayModel.day ==1 ) {
        NSLog(@" 6 %ld-%ld",(long)dayModel.month,(long)dayModel.day);
        cell.signView.backgroundColor = [UIColor yellowColor];
